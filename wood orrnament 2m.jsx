function xuLy(arr, wAll, hAll, FileDesign, FileName, type) {
    ...
    for (var i = 0; i <= arr.length - 1; i++) { // loop làm file in
        ...
        #include "normal image size mica 2 side.jsx"; // xử mở và xử lý file, đưa sang document GLLM
            ...
            //     app.activeDocument.activeLayer.duplicate(app.documents["GLLM"].layerSets["tem"], ElementPlacement.PLACEATBEGINNING);// đưa file in sang bên bàn in
            //     app.activeDocument.close(SaveOptions.DONOTSAVECHANGES);
...

        {
            ...
            app.activeDocument.layerSets["CMYK"].name="in 1";
            app.activeDocument.layerSets["SPOT"].name="in 2";
