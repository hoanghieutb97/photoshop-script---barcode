        ...
        #include "compute coordinates.jsx"; // tính toán toạ độ
...

            {
                try {
                    ...
                    // if (arr[i][j].partner == "PW64") {
                    //     if (app.activeDocument.width == 2970)
                    //         app.doAction("canvas su", "fx");
                    //     else {
                    //         app.activeDocument.resizeImage(null, UnitValue(2970, "px"), null, ResampleMethod.BICUBIC);
                    //         app.doAction("canvas su", "fx");
                    //     }
