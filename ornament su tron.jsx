    ...
    for (var i = 0; i <= arr.length - 1; i++) { // loop làm file in
        ...
        #include "compute coordinates.jsx"; // tính toán toạ độ
...

            {
                ...
                if (app.activeDocument.width > app.activeDocument.height) app.doAction("crop su tron 898px doc", "go")
                else app.doAction("crop su tron 898 px ngang", "go")

                app.doAction("crop su tron tool", "go");
            ...
            {// tao khung su
                    app.open(File("~/Desktop/khung tron.png"));
                app.activeDocument.activeLayer.name = arr[i][j].stt;
